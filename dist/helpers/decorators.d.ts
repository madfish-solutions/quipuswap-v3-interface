...
export declare function sendAndConfirmation<T>(contract: Contract, tezos: TezosToolkit, callback: (contract: Contract, ...params: T[]) => TransferParams, SYNC_INTERVAL: number, CONFIRM_TIMEOUT: number, ...callParams: T[]): Promise<any>;

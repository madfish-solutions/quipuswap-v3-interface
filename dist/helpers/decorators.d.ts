...
export declare function sendAndConfirmation<T>(contract: Contract, tezos: TezosToolkit, callback: (contract: Contract, ...params: T[]) => TransferParams, confirmationCount: number, ...callParams: T[]): Promise<BatchWalletOperation>;
